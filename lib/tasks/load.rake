...
task 'load_data' => [:environment] do
  ...
  Question.new(:points_available => 10, :name => "What is your name?", :answer => 'Sir Lancelot').tap do |question|
  ...
  Question.new(:points_available => 10, :name => "What is your quest?", :answer => 'To Seek the Holy Grail').tap do |question|
  ...
  Question.new(:points_available => 10, :name => "What is your favorite colour?", :answer => 'Blue').tap do |question|
